    ...
    <div class = "container">
        <table>
            <form action = "workingdays.cfm" method = "post">
                <tr> 
                    <td> Group Name: </td> 
                    <td> <input type = "Text" maxlength = "20" class = "form-control" name = "txt_group_name" required <cfif structKeyExists(url, 'edit')> value = "#get_workingdays.group_name#" </cfif> > </td>
                </tr>
                <tr>
                    <td> Monday : </td> 
                    <td> <select name = "monday" class = "form-select">
                ...
                <tr>
                    <td> Tuesday : </td> 
                    <td> <select name = "tuesday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Wednesday : </td> 
                    <td> <select name = "wednesday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Thursday : </td> 
                    <td> <select name = "thursday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Friday : </td> 
                    <td> <select name = "friday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Saturday : </td> 
                    <td> <select name = "saturday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Sunday : </td> 
                    <td> <select name = "sunday" class = "form-select">
                            <option value = "1" > Working Day </option>
                ...
                <tr>
                    <td> Time In: </td> 
                    <td> <input name = "time_in" type = "time" class = "form-control" <cfif structKeyExists(url, 'edit')> value = "#Timeformat(get_workingdays.time_in , "hh:mm")#" <cfelse> value = "09:00" </cfif> > </td>
                </tr>
                    <td> Time Out: </td> 
                    <td> <input name = "time_out" type = "time" class = "form-control" <cfif structKeyExists(url, 'edit')> value = "#Timeformat(get_workingdays.time_out , "hh:mm")#" <cfelse> value = "18:00" </cfif>> </td>
                </tr>
                <tr>
                    <td> Break Time: </td>
                    <td> <input name = "break_time" type = "number" class = "form-control"  min = "0"min = "0" required <cfif structKeyExists(url, 'edit')> value = "#get_workingdays.break_time#" </cfif> > </td>
                </tr>
                <tr>
                    <td> Friday Time In: </td> 
                    <td> <input name = "Friday_time_in" type = "time" value = "09:00" class = "form-control" <cfif structKeyExists(url, 'edit')> value = "#Timeformat(get_workingdays.friday_time_in , "hh:mm")#" <cfelse> value = "09:00" </cfif>> </td>
                </tr>
                    <td> Friday Time Out: </td> 
                    <td> <input name = "Friday_time_out" type = "time" value = "18:30" class = "form-control" <cfif structKeyExists(url, 'edit')> value = "#Timeformat(get_workingdays.time_out , "hh:mm")#" <cfelse> value = "18:30" </cfif>> </td>
                </tr>
                <tr>
                    <cfif structKeyExists(url, 'edit')> 
                    <input type = "hidden" name = "group_id" value = "#url.edit#"> 
                    </cfif>
                    <td> <input type = "submit" class = "btn btn-outline-dark" <cfif structKeyExists(url, 'edit')> name = "update" value = "Update" <cfelse> value = "Submit" name = "submit" </cfif> > </td>
                </tr>
            </form>
        </table>
    </div>
